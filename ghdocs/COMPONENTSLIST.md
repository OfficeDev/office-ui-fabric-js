...
The [Office UI Fabric React](https://github.com/OfficeDev/office-ui-fabric-react) project contains more components with greater functionality, so we often recommend checking out this project as well.
...
## Components
 ...
 - [ContextualMenu](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/ContextualMenu.md)
 - [DatePicker](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/DatePicker.md)
 - [Dialog](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/Dialog.md)
 - [Dropdown](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/Dropdown.md)
 - [FacePile](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/FacePile.md)
 ...
 - [List](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/List.md)
 - [ListItem](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/ListItem.md)
 ...
 - [OrgChart](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/OrgChart.md)
 ...
 - [PeoplePicker](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/PeoplePicker.md)
 - [Persona](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/Persona.md)
 - [PersonaCard](https://github.com/OfficeDev/office-ui-fabric-js/blob/master/ghdocs/components/PersonaCard.md)

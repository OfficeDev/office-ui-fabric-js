...
2. Copy the HTML from one of the samples above into your page. For example:
    ...
    <div class="ms-PersonaCard ">
        ...
        <div class="ms-PersonaCard-actionDetailBox" style="overflow-y: hidden; transition-property: height; transition-duration: 0.25s; transition-delay: 0s; height: 108px;">
            <div data-detail-id="mail" class="ms-PersonaCard-details">
                ...
                <div class="ms-PersonaCard-detailLine">
                    <span class="ms-PersonaCard-detailLabel">Work:</span>
            ...
            <div data-detail-id="chat" class="ms-PersonaCard-details">
                <div class="ms-PersonaCard-detailLine">
                    <span class="ms-PersonaCard-detailLabel">Lync:</span>
                    <a class="ms-Link" href="#">Start Lync call</a>
                </div>
            </div>
            <div data-detail-id="phone" class="ms-PersonaCard-details is-active">
                <div class="ms-PersonaCard-detailExpander"></div>
                <div class="ms-PersonaCard-detailLine"><span class="ms-PersonaCard-detailLabel">Details</span></div>
            ...
            <div data-detail-id="video" class="ms-PersonaCard-details">
                <div class="ms-PersonaCard-detailLine">
                    <span class="ms-PersonaCard-detailLabel">Skype:</span>
